package bg.softuni.garage.common.aspect;
...
public class ServiceMonitoringAspect {
    ...
    private static final long SLOW_CALL_MILLIS = 500;

    @Pointcut("within(@org.springframework.stereotype.Service bg.softuni.garage..*)")
